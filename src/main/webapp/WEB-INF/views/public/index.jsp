                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked category-menu">
                            <c:forEach items="${categories}" var="category">
                                <li <c:if test="${category.id == cat.id}">class="active" </c:if>>
                                    <a href="/product?cat=${category.id}"> ${category.name}</a>
                                    <c:if test="${category.children != null && category.id == cat.id}">
                                        <ul>
                                            <c:forEach items="${category.children}" var="child">
                                                <li>
                                                    <a href="/product?cat=${category.id}&child=${child.id}">${child.name}</a>
                                                </li>
                                            </c:forEach>
                                        </ul>
                                    </c:if>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <c:if test="${child == null}" >
                                    <h3 class="col-md-12 pull-left">${cat.name}</h3>

                                    <div class="col-md-2">
                                        <img src='<c:url value="/images${cat.image.path}"/>'
                                             alt="" style="width:100px;height:100px;" class="img-responsive">
                                    </div>
                                    <div class="col-md-10">
                                        <p>${cat.description}</p>
                                    </div>
                                    <h4 class="col-md-12 pull-left">Refine search</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <ul class="col-md-3">
                                                ...
                                                <ul class="col-md-3">
                                                    ...
                                                    <li>
                                                        <a href="/product?cat=${cat.id}&child=${child.id}">${child.name}</a>
                                                    </li>
                                                    </c:forEach>
                                                </ul>
                                        </div>
                                ...
                                <c:if test="${child != null}" >
                                    <h3 class="col-md-12 pull-left">${child.name}</h3>

                                    <div class="col-md-2">
                                        <img src='<c:url value="/images${child.image.path}"/>'
                                             alt="" style="width:100px;height:100px;" class="img-responsive">
                                    </div>
                                    <div class="col-md-10">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <c:forEach items="${child.children}" var="catChild" varStatus="status">
                                            <c:if test="${status.index > 0 && status.index % 5 == 0}">
                                            </ul>
                                            <ul class="col-md-3">
                                                </c:if>
                                                ...
                                                <ul class="col-md-3">
                                                    ...
                                                    <li>
                                                        <a href="/product?cat=${child.id}&child=${catChild.id}">${catChild.name}</a>
                                                    </li>
                                                    </c:forEach>
                                                </ul>
                                        </div>
